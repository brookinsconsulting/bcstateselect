<?php
//
// Definition of BcStateSelectType class
//
...
/*!
  \class BcStateSelectType bcstateselecttype.php
  \ingroup eZDatatype
...
//                                                                         $currentVersion );
    ...
    */
    function validateObjectAttributeHTTPInput( &$http, $base, &$contentObjectAttribute )
    {
        ...
        {
            $data = $http->postVariable( $base . '_bcstateselect_data_text_' . $contentObjectAttribute->attribute( 'id' ) );
    ...
    */
    function fetchCollectionAttributeHTTPInput( &$collection, &$collectionAttribute, &$http, $base, &$contentObjectAttribute )
    {
        if ( $http->hasPostVariable( $base . "_bcstateselect_data_text_" . $contentObjectAttribute->attribute( "id" ) ) )
        {
            $dataText = $http->postVariable( $base . "_bcstateselect_data_text_" . $contentObjectAttribute->attribute( "id" ) );
